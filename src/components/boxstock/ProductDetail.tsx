        ...
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          <div className="w-[55%] max-md:w-full max-md:ml-0">
            <div className="mt-[7px] max-md:max-w-full max-md:mt-10">
              <ProductGallery />
              <div className="max-w-full w-[590px] text-center mt-8">
                <div className="items-center flex min-h-[338px] flex-col bg-[#AEDDE8] px-[41px] py-11 max-md:max-w-full max-md:px-5">
                  <div className="flex max-w-full w-[490px] flex-col items-center text-[#00262F]">
                    ...
                    <div className="text-[#00262F] text-[32px] font-bold leading-10 max-md:max-w-full">
                  ...
                  <div className="flex max-w-full w-[490px] flex-col items-center text-xl mt-8">
                    <button className="w-full text-white font-bold leading-[1.2] bg-[#E41A36] pt-[17px] pb-[11px] px-[49px] max-md:px-5">
                      Verkoop dit item
                    </button>
                    <div className="text-[#00262F] font-normal underline decoration-solid decoration-auto underline-offset-auto underline mt-4">
                      Hoe werkt resell?
                    </div>
                  </div>
                </div>
