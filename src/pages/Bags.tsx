...
import { ChevronDown, ChevronUp, Filter, ShoppingBag, Star } from 'lucide-react';
  ...
  const products = [
    {
      id: 1,
      brand: "Supreme",
      name: "Supreme Shoulder Bag FW20 Black",
      price: "€79,00",
    ...
    },
    {
      id: 3,
      brand: "Carhartt WIP",
      name: "Carhartt WIP Essentials Bag Small",
      price: "€35,00",
    ...
    },
    {
      ...
      name: "The North Face Base Camp Duffel S",
      price: "€130,00",
    ...
    },
    {
      id: 5,
      brand: "Eastpak",
      name: "Eastpak Padded Pak'r Backpack Black",
      price: "€55,00",
    ...
    },
    {
      id: 6,
      brand: "Off-White",
      name: "Off-White Industrial Crossbody Bag Yellow",
      price: "€195,00",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="flex items-center gap-2 mb-8 text-sm">
          ...
          <span className="text-[#00262F]">Tassen</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/4">
            ...
            <div className="bg-white rounded-lg p-6 mb-6">
              <h1 className="text-3xl font-bold text-[#00262F] mb-4">Tassen</h1>
              ...
              <nav className="space-y-2">
                ...
                <Link to="/bags" className="block font-bold text-[#00262F] border-b-2 border-[#00262F] pb-1">
                  Tassen
                </Link>
          ...
          <div className="w-full md:w-3/4">
            ...
            <div className="bg-white rounded-lg p-6 mb-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-[#00262F]">Alle Tassen</h2>
