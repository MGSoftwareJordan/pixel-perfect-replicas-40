...
const Accessories: React.FC = () => {
  ...
  const brands = [
    "Kith", "Comme des garçons", "Coperni", "A-cold-wall*", "Prada", "Junya Watanabe",
    "Supreme", "The North Face", "Carhartt WIP", "Stone Island", "Off-White"
  ];
  ...
  const products = [
    ...
    },
    {
      ...
      name: "The North Face Borealis Classic Backpack",
      price: "€120,00",
    ...
    },
    {
      id: 5,
      brand: "Carhartt WIP",
      name: "Carhartt WIP Watch Hat Beanie Black",
      price: "€29,99",
    ...
    },
    {
      id: 6,
      brand: "Stone Island",
      name: "Stone Island Nylon Metal Cap Blue",
      price: "€125,00",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="flex items-center gap-2 mb-8 text-sm">
          ...
          <span className="text-[#00262F]">Accessoires</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/4">
            ...
            <div className="bg-white rounded-lg p-6 mb-6">
              <h1 className="text-3xl font-bold text-[#00262F] mb-4">Accessoires</h1>
              ...
              <nav className="space-y-2">
                ...
                <Link to="/accessories" className="block font-bold text-[#00262F] border-b-2 border-[#00262F] pb-1">
                  Accessoires
                </Link>
                      ...
                      <RadioGroup defaultValue="all-brands">
                        ...
                        {brands.map((brand, index) => (
                          <div key={index} className="flex items-center space-x-2">
                            <RadioGroupItem value={brand.toLowerCase().replace(/\s+/g, '-')} id={`brand-${index + 1}`} />
          ...
          <div className="w-full md:w-3/4">
            ...
            <div className="bg-white rounded-lg p-6 mb-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-[#00262F]">Alle Accessoires</h2>
