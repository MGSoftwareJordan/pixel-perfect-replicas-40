...
import { ChevronDown, ChevronUp, Filter, Shirt, Star } from 'lucide-react';
...
const Clothing: React.FC = () => {
  ...
  const products = [
    ...
    },
    {
      id: 4,
      brand: "Carhartt WIP",
      name: "Carhartt WIP Chase Sweatshirt Grey Heather",
      price: "€85,00",
    ...
    },
    {
      id: 5,
      brand: "Supreme",
      name: "Supreme Box Logo Hooded Sweatshirt Red",
      price: "€399,00",
          ...
          <div className="w-full md:w-1/4">
            ...
            <div className="bg-white rounded-lg p-6 space-y-6">
              ...
              <div>
                ...
                >
                  <h3 className="font-medium text-[#00262F]">Maat</h3>
                  {showFilters.sizes ? 
                    <ChevronUp size={18} /> : 
                    <ChevronDown size={18} />
                  }
          ...
          <div className="w-full md:w-3/4">
            ...
            <div className="bg-white rounded-lg p-6 mb-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-[#00262F]">Alle Kleding</h2>
